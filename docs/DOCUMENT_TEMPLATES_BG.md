...
- Repair v5: общ тричастов комплект — (1) приемане/състояние/необходим ремонт/диагностика, (2) извършени дейности/демонтирани и вложени части, (3) реални продължителности/тест/краен резултат/приложения/приемане. Първата страница използва byte-level същите embedded company header media като approved transfer v3, без промяна на transfer шаблоните.
...
- executable repair BG v5 template: `e324bb1f74cf1e60f88774d550ef1ae6eb46ef8fe7a49c2e9a263e2f63d061e0`;
