...
Проверени са всички 581 действително отпечатани позиции като 818 отделни области, включително повторенията в детайли и сечения. Позиция `0` при Falch 500 unloader valve и Falch 1000 drive pump е BOM ред за цял възел и проверено не е отпечатана като указател. Таблицата остава равноправен двупосочен вход към схемата. Методът и точните показатели са в [CATALOG_POSITION_MAPPING_VALIDATION_BG.md](CATALOG_POSITION_MAPPING_VALIDATION_BG.md).
