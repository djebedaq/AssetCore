...
def _seed_document_templates(db: Session) -> None:
    ...
    references = [
        ...
        },
        {
            ...
            "template_version": 6,
            "required_fields": [
                "MACHINE_NUMBER", "REPAIR_REFERENCE", "REPORTED_PROBLEM",
                "CONDITION_BEFORE", "DIAGNOSTIC_CLEANING",
            ...
            "contract": {
                ...
                "sections": [
                    ...
                    "required_repair", "disassembly", "diagnostic_cleaning",
                    "diagnosis", "required_parts",
