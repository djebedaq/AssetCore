...
export const passport: MachinePassport = {
  ...
  machine: {
    ...
    category: 'HPWJ', category_definition: { id: 1, code: 'HPWJ', name_bg: 'Водоструйни машини', name_en: 'Water-jet machines', name_ru: 'Водоструйные машины', is_active: true, created_at: '2026-09-01T00:00:00Z', fields: [], capabilities: ['HAS_PRESSURE', 'HAS_PARTS_CATALOG', 'HAS_REPAIR_WORKFLOW', 'HAS_TRANSFER_WORKFLOW'] },
