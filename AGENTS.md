...
- Bulgarian is the default language. Keep complete, key-parity translations for Bulgarian, English and Russian; do not hardcode user-facing text in React components.
